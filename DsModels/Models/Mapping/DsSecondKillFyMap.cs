...
{
    public class DsSecondKillFyMap : EntityTypeConfiguration<DsSecondKillFy>
    {
        public DsSecondKillFyMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.Property(t => t.SecondKillID)
                .IsRequired()
                .HasMaxLength(32);
            ...
            this.Property(t => t.ShowBuildingHouseSqmPrice).HasColumnName("ShowBuildingHouseSqmPrice");
            ...
            this.Property(t => t.SecondKillID).HasColumnName("SecondKillID");
