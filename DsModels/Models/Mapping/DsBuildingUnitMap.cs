...
{
    public class DsBuildingUnitMap : EntityTypeConfiguration<DsBuildingUnit>
    {
        public DsBuildingUnitMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.Property(t => t.DanYuanID)
                .IsRequired()
                .HasMaxLength(50);

            // Table & Column Mappings
            this.ToTable("DsBuildingUnit");
            ...
            this.Property(t => t.DanYuanID).HasColumnName("DanYuanID");
        }
    }
}
